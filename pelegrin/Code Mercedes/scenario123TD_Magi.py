...
Original file is located at
    https://colab.research.google.com/drive/1xs5gZGVS-yolHsZ-GUon0vNcwLvk9yiN
"""
...
# input parameters
input_file = "/content/drive/MyDrive/Colab Notebooks/metroplex/metroplex0.txt"
output_file = "/content/drive/MyDrive/Colab Notebooks/metroplex/D_metroplex0.txt"
random_seed = "0"
verbose = int("1")  # print outputs?
compareWithLocal = int(
    "0"
)  # run AMPL only with "inConflict" pairs (not global approach)
nDrift = int("1")  # scenario 1: num drift
#TODO  provare con 1 drift e basta, con 1,2,3 delays senza drift e 1 drift e 1 delay
nDelay = int("1")  # scenario 1: num delayed
nIntru = int(
    "0"
...
"""## Read strategial deconfliction schedule
important parts:
fato mean Final Approach and Takeoff Area -> starting or ending node
...
"""## Function to create collab. intruder
...
"""## Function to create non-collab. intruder
funzioni per aggiungere intruder non collaborativi
"""
