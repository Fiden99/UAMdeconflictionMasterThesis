...
for nDelay in {1..3}; do
    python3 /home/magi/UAMdeconflictionMasterThesis/pelegrin/Code\ Mercedes/scenario123Free.py $topology $seed 0 $nDelay 0 0
done
python3 /home/magi/UAMdeconflictionMasterThesis/pelegrin/Code\ Mercedes/scenario123Free.py $topology $seed 0 0 1 0
python3 /home/magi/UAMdeconflictionMasterThesis/pelegrin/Code\ Mercedes/scenario123Free.py $topology $seed 0 0 0 1
