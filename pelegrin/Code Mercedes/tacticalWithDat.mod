...
set A; #aircraft
set GROUND within A default {}; #aircraft on ground when TD is called
set INFLIGHT:=A diff GROUND;
set DELAYED within GROUND default {};
set AP within A default {}; #aircraft with priority (collaborative intruder)
set AP_NC within A default {}; #aircraft not modifiable (non-collaborative intruder)
