#!/bin/bash
#SBATCH --job-name=DDHeurMercedes       # Nome del job
...
#SBATCH --array=0-300%60                # Numero di job da eseguire

# Crea una lista di tutti i file .dat nella directory "data/"
FILES=($(ls /home/magi/UAMdeconflictionMasterThesis/modelli/data/mercedesTDHeur/metroplex*.dat))
