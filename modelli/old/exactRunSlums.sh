#!/bin/bash
#SBATCH --job-name=Metroplex_exact_UAM_array_job       # Nome del job
#SBATCH --output=/home/magi/UAMdeconflictionMasterThesis/modelli/out/exact/12/ampl_output_%A_%a.txt  # File di output per stdout (%A = job ID, %a = array task ID)
#SBATCH --error=/home/magi/UAMdeconflictionMasterThesis/modelli/out/exact/12/ampl_error_%A_%a.txt    # File di output per stderr
...
FILES=($(ls /home/magi/UAMdeconflictionMasterThesis/modelli/data/metroplex*.dat))
...
value="12" nNodes="3" nFlights="100" absPath=$PWD datFile=$datFileBase ampl /home/magi/UAMdeconflictionMasterThesis/modelli/UAMserver.run
