...
#SBATCH --output=/home/magi/UAMdeconflictionMasterThesis/modelli/out/nn5nf100/24/ampl_output_%A_%a.txt  # File di output per stdout (%A = job ID, %a = array task ID)
#SBATCH --error=/home/magi/UAMdeconflictionMasterThesis/modelli/out/nn5nf100/24/ampl_error_%A_%a.txt    # File di output per stderr
...
value="24" nNodes="5" nFlights="100" absPath=$PWD datFile=$datFileBase ampl /home/magi/UAMdeconflictionMasterThesis/modelli/tHeuristic.run
