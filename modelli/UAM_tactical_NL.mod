...
t_down[f,y]=sum{(x,y) in E} w[x,y,f] *(d[x,y]/v_max[f,x,y] + t_ear[f,x]);
subject to defineT_up{f in F,y in V: y <> s[f]}:
t_up[f,y]=sum{(x,y) in E} w[x,y,f] * (d[x,y]/v_min[f,x,y] + t_ear[f,x]);

# conflicts


subject to trail13 {i in F,j in F, (x,y) in E: i<>j and (t_hat_ear[i,x] < t_hat_ear[j,x] or (t_hat_ear[i,x] == t_hat_ear[j,x] and i<j))}:
(w[x,y,i] + w[x,y,j] == 2) ==> (t_ear[j,x]-t_lat[i,x] >= D/v_min[i,x,y]-bigM* passFirst[i,j,x]);
...
(w[x,y,i] + w[x,y,j] == 2) ==> (t_ear[i,x]-t_lat[j,x]>=D/v_min[j,x,y]* (1-passFirst[i,j,x]) - bigM*passFirst[i,j,x]);
...
(w[x,y,i] + w[x,y,j] == 2) ==> t_ear[j,y]-t_lat[i,y]>= D/v_min[j,x,y]* passFirst[i,j,x] - bigM*(1-passFirst[i,j,x]);
...
(w[x,y,i] + w[x,y,j] == 2) ==> t_ear[i,y]-t_lat[j,y]>= D/v_min[i,x,y] * (1-passFirst[i,j,x]) - bigM*passFirst[i,j,x];
...
(w[x1,x,i]+w[x2,x,j] == 2) ==> (t_ear[j,x]- t_lat[i,x]>=angleM[x,x1,x2]*D/v_min[j,x2,x] * passFirst[i,j,x] - bigM*(1-passFirst[i,j,x]));
...
(w[x1,x,j]+w[x2,x,i] == 2) ==> (t_ear[j,x]- t_lat[i,x]>=angleM[x,x1,x2]*D/v_min[i,x2,x] * passFirst[i,j,x] - bigM*(1-passFirst[i,j,x]));
...
(w[x1,x,j]+w[x2,x,i] == 2) ==> (t_ear[i,x]- t_lat[j,x]>=angleM[x,x1,x2]*D/v_min[j,x1,x]* (1-passFirst[i,j,x]) - bigM*passFirst[i,j,x]);
...
(w[x1,x,i]+w[x2,x,j] == 2) ==> (t_ear[i,x]- t_lat[j,x]>=angleM[x,x1,x2]*D/v_min[i,x1,x]* (1-passFirst[i,j,x]) - bigM*passFirst[i,j,x]);
...
(w[x,x1,i]+w[x2,x,j] == 2) ==> (t_ear[j,x]- t_lat[i,x]>=anglePM[x,x1,x2]*(D/v_min[j,x2,x]+D/v_min[i,x,x1])*passFirst[i,j,x] - bigM*(1-passFirst[i,j,x])) ;
...
(w[x,x1,j]+w[x2,x,i] == 2) ==> (t_ear[j,x]- t_lat[i,x]>=anglePM[x,x1,x2]*(D/v_min[i,x2,x]+D/v_min[j,x,x1])*passFirst[i,j,x] - bigM*(1-passFirst[i,j,x])) ;
...
(w[x,x1,i]+w[x2,x,j] == 2) ==> (t_ear[i,x]- t_lat[j,x]>=anglePM[x,x1,x2]*(D/v_min[j,x2,x]+D/v_min[i,x,x1])* (1-passFirst[i,j,x]) - bigM*passFirst[i,j,x]);
...
(w[x,x1,j]+w[x2,x,i] == 2) ==> (t_ear[i,x]- t_lat[j,x]>=anglePM[x,x1,x2]*(D/v_min[i,x2,x]+D/v_min[j,x,x1])* (1-passFirst[i,j,x]) - bigM*passFirst[i,j,x]);
...
(w[x,x1,i]+w[x,x2,j] == 2) ==> (t_ear[j,x]- t_lat[i,x]>=angleP[x,x1,x2]*D/v_min[i,x,x1]*passFirst[i,j,x] - bigM*(1-passFirst[i,j,x]));
...
(w[x,x1,j]+w[x,x2,i] == 2) ==> (t_ear[j,x]- t_lat[i,x]>=angleP[x,x1,x2]*D/v_min[j,x,x1]*passFirst[i,j,x] - bigM*(1-passFirst[i,j,x]));
...
(w[x,x1,i]+w[x,x2,j] == 2) ==> (t_ear[i,x]- t_lat[j,x]>=angleP[x,x1,x2]*D/v_min[j,x,x2] * (1-passFirst[i,j,x]) - bigM*passFirst[i,j,x]);
...
(w[x,x1,j]+w[x,x2,i] == 2) ==> (t_ear[i,x]- t_lat[j,x]>=angleP[x,x1,x2]*D/v_min[i,x,x2] * (1-passFirst[i,j,x]) - bigM*passFirst[i,j,x]);
