...
(w[x1,x,i]+w[x2,x,j] +w[x1,x,j]+w[x2,x,i] >= 2) ==> (t_ear[j,x]- t_lat[i,x]>=angleM[x,x1,x2]*D/v_min[j,x2,x] * passFirst[i,j,x] - bigM*(1-passFirst[i,j,x]));
...
(w[x1,x,i]+w[x2,x,j] +w[x1,x,j]+w[x2,x,i] >= 2) ==> (t_ear[i,x]- t_lat[j,x]>=angleM[x,x1,x2]*D/v_min[i,x1,x]* (1-passFirst[i,j,x]) - bigM*passFirst[i,j,x]);
...
(w[x,x1,i]+w[x2,x,j] +w[x,x1,j]+w[x2,x,i] >= 2) ==> (t_ear[j,x]- t_lat[i,x]>=anglePM[x,x1,x2]*(D/v_min[j,x2,x]+D/v_min[i,x,x1])*passFirst[i,j,x] - bigM*(1-passFirst[i,j,x])) ;
...
(w[x,x1,i]+w[x2,x,j] +w[x,x1,j]+w[x2,x,i] >= 2) ==> (t_ear[i,x]- t_lat[j,x]>=anglePM[x,x1,x2]*(D/v_min[i,x2,x]+D/v_min[j,x,x1])* (1-passFirst[i,j,x]) - bigM*passFirst[i,j,x]);
...
(w[x,x1,i]+w[x,x2,j] + w[x,x1,j]+w[x,x2,i] >= 2) ==> (t_ear[j,x]- t_lat[i,x]>=angleP[x,x1,x2]*D/v_min[i,x,x1]*passFirst[i,j,x] - bigM*(1-passFirst[i,j,x]));
...
(w[x,x1,i]+w[x,x2,j] + w[x,x1,j]+w[x,x2,i] >= 2) ==> (t_ear[i,x]- t_lat[j,x]>=angleP[x,x1,x2]*D/v_min[j,x,x2] * (1-passFirst[i,j,x]) - bigM*passFirst[i,j,x]);
