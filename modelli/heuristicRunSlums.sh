...
#SBATCH --output=/home/magi/UAMdeconflictionMasterThesis/modelli/out/nn3nf100/18/ampl_output_%A_%a.txt  # File di output per stdout (%A = job ID, %a = array task ID)
#SBATCH --error=/home/magi/UAMdeconflictionMasterThesis/modelli/out/nn3nf100/18/ampl_error_%A_%a.txt    # File di output per stderr
...
value="18" nNodes="3" nFlights="100" absPath=$PWD datFile=$datFileBase ampl /home/magi/UAMdeconflictionMasterThesis/modelli/reducedHeuristicAlgo.run
